...
const swaggerDefinition = {
  info: {
    title: "REST API ORDENES ELAISS",
    version: "1.0.0",
    description: "API ORDENES - ELAISS"
  },
...
app.use('/api-docs-ordenes', swaggerUi.serve, swaggerUi.setup(swaggerSpec));
/*
**********  FIN CONFIGURACION DE SWAGGER  **************
*/
app.use("/api/ordenes/", require('./api/routers/routers_ordenes'));
